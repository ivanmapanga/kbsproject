...
Original file is located at
    https://colab.research.google.com/drive/1LBdACPeNk2KAoHdL2WmT_Y3MNP0ApXP1

Ivan Mapanga **R179865K** | Kundai Mujati **R178459** | Sinikiwe Ngwenya **R176519R**
"""
...
model = keras.models.load_model('/content/drive/MyDrive/hct404project/full_CNN_model.h5')
...
def success():
	if request.method == 'POST':
		...
		cv2.imwrite(PROCESSED_FOLDER+hls_name, output_image_after_detecting)
    x = load_img(PROCESSED_FOLDER, target_size=(224,224,3))
						x = img_to_array(x)
